...
export default function About() {
  ...
  return (
    <>
      <Helmet>
        <title>RoboShop | About</title>
        <meta
          name="description"
          content="RoboShop presents over 1000+ products from popular brands at the never-seen-before price range with 20-days money back guarantee and cash on delivery!"
        />
        <meta
          name="keywords"
          content="smartphones,
              ...
              <div className="w-full lg:w-1/2 xl:w-5/12 px-4">
                <div className="-mt-2 lg:mt-0">
                  <span className="font-semibold text-lg text-gray-700 mb-2 block">
                    ...
                    <span className="text-logogreen">RoboShop</span>
                  </span>
                  <h2 className="font-bold text-3xl sm:text-4xl text-dark mb-8">
                    RoboShop Enployee Page
                  </h2>
                  <p className="text-base text-body-color mb-8">
                    RoboShop's employee are dedicated and hard-working individuals
